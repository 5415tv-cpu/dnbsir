...
# 3. Cloud Build
Write-Host "[3/6] Running Google Cloud Build..." -ForegroundColor Yellow
$timestamp = Get-Date -Format "yyyyMMdd-HHmmss"
$tagName = "${IMAGE_NAME}:${timestamp}"

gcloud builds submit --project $PROJECT_ID --tag $tagName .
...
KAKAO_CLIENT_ID: cf44d0281c879804571f2964f39c09ed
